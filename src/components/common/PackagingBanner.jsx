...
function PackagingBanner({
  ...
  return (
    ...
    <div className=' sm:max-w-7xl max-w-[95%] my-2 mt-5 mx-auto rounded-[8px] h-[300px] p-5 bg-[#00000084] bg-cover bg-no-repeat bg-blend-multiply' style={{backgroundImage:`url(${bgImage})`}}>
