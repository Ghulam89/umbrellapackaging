  ...
  return (
    <>
        ...
        <div className=' sm:max-w-6xl max-w-[95%] mx-auto'>
            <div className="flex flex-col lg:flex-row gap-8 items-center">
                    ...
                    <div className=" pt-3">
                        ...
                        Protective & Customized Automotive Packaging Boxes
                        </h3>
                       <div className=' overflow-y-auto h-56'>
                       <p className="text-sm leading-6 text-gray-700 mb-6">
                        If you are thinking about custom Automotive packaging boxes for your Automotive it means you have understood that personalized Automotive boxes could make your product look extra special. Custom Automotive box packaging can make your product feel more attractive and valuable, catching customers’ attention and increasing their understanding of its quality and value. From concept to completion, our custom packaging experts will guide you through every step of the process. They will help you to find the exact size, style, and material making your custom Automotive boxes’ first impression memorable which leaves a lasting impact.
                        They will help you to find the exact size, style, and material making your custom Automotive boxes’ first impression memorable which leaves a lasting impact.
                        </p>
                       </div>
            ...
            <div className="w-full  lg:w-1/2">
              <img 
                src={'https://umbrellapackaging.com/wp-content/uploads/elementor/thumbs/Automotive-Boxes--r238xa6empe2pkyu7y166u5w7ecczcxf3iy6uym9wg.webp'} 
     ...
     <div className='  py-6'>
        ...
        <div className=' py-12'>
          ...
          <div className=" grid sm:grid-cols-4 grid-cols-2  space-x-4 space-y-3 mt-3.5 justify-between">
                ...
                <div className=' flex justify-center'>
                 ...
                 <div className=' '>
                    ...
                    <div className=' flex sm:flex-row flex-col gap-5  mt-5 bg-[#EFF4FE] p-4 rounded-lg justify-between'>
                        ...
                        <iframe width="100%" className=' rounded-lg' height="315" src="https://www.youtube.com/embed/XY8xNV931F4?start=2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div className=' sm:w-6/12 w-full'>
                          <h1>Automotive Boxes Video Guide</h1>
                          <p className=' pt-4 pb-3'>Umbrella Custom Packaging offers customized Automotive box packaging and printing solutions for all your Automotive products. We have technologically advanced digital and offset presses. It makes sure that every Automotive box we print has high quality. Our skilled staff enables us to present perfect printed designs and styles. For custom quotes or inquiries, feel free to contact our representatives from Monday-Friday.
                          </p>
                    ...
                    <div className=" pt-3">
                        ...
                        How would one define Automotive Boxes?
                        </h1>
                       <div className=' overflow-y-auto h-56'>
                       <p className="text-sm leading-6 text-gray-700 mb-6">
                       Firstly, let’s focus on custom Automotive packaging boxes, what are they? We use these special boxes to protect and carry your Automotive products, from one place to another. Unlike standard boxes, they are customizable, considering factors like size, shape, material, and printing to fully fit the product they hold. All in all, custom-printed Automotive boxes with logo play an important role in product presentation and protection. It allows the brand to display its unique identity and branding.


                        </p>
                       <p className="text-sm leading-6 text-gray-700 mb-6">
                       Moreover, personalized Automotive boxes create an unforgettable unboxing experience, promoting brand loyalty which inspires repeat purchases in e-commerce. A well-designed and customized Automotive packaging plan can help the brand stand out in the market. So, here is a chance to think about a custom Automotive box that should be well-designed, precisely sized, and perfectly shaped. It will take your business to new heights. Overall, whatever you are thinking, take your chance, nothing is out of our reach.
            ...
            <div className="w-full  lg:w-1/2">
              <img 
                src={'https://umbrellapackaging.com/wp-content/uploads/elementor/thumbs/Automotive-packaging-Boxes--r21ibq49c0fvlidvetzd8ijowxu8ncgn9gc3yrznog.webp'} 
                alt="Custom packaging example" 
                className="w-full h-auto rounded-xl shadow-md object-cover"
                loading="lazy"
              />
     ...
     <div className="flex flex-col bg-[#F4ECFB] px-4 py-6  rounded-lg lg:flex-row mt-10 gap-8 items-center">
                    ...
                    <div className=" pt-3">
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                        Quality Printed Custom Automotive Boxes Well-designed to Stand out
                        </h1>
                       <div className=' overflow-y-auto h-56'>
                       <p className="text-sm leading-6 text-gray-700 mb-6">
                       Customized Automotive packaging is the ultimate need for an Automotive business to withstand in today’s competitive market. The effective way to do this is by using attractive and effective packaging solutions. Our creative design department is smart enough to give creative suggestions to businesses for their design approach toward custom-printed Automotive boxes. The department is operating free of cost for designing the Automotive boxes with logo and artwork that customers give us.



                        </p>
                       <p className="text-sm leading-6 text-gray-700 mb-6">
                       As a leading packaging brand in the industry, Umbrella Custom Packaging loves thinking up creative and cool ideas. We want it to be different and exciting, like making a surprise just for you! There is a variety of additional features that enhance the printing quality which include; spot UV, custom foiling, embossing, debossing, and holographic printing, and Automotive packaging with insert is also trending. Overall, custom Automotive box packaging with logo printing has a great effect.
            ...
            <div className="w-full  lg:w-1/2">
              <img 
                src={'https://umbrellapackaging.com/wp-content/uploads/elementor/thumbs/Custom-printed-Automotive-Boxes--qvc4jcap50holgvktbaosoe6m8uaopkzgwvxm3on1c.webp'} 
                alt="Custom packaging example" 
                className="w-full h-auto rounded-xl shadow-md object-cover"
                loading="lazy"
              />
